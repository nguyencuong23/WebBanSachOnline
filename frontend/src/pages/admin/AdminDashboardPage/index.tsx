    ...
    <div>
      <div className="d-flex justify-content-between align-items-center mb-4">
        <div>
          ...
          <p className="text-muted mb-0">Tổng quan hệ thống thư viện thương mại</p>
        </div>
      </div>
      ...
      <div className="dashboard-card p-4">
        ...
        <div className="d-flex gap-2 flex-wrap">
          ...
          <Link className="btn btn-outline-primary" to="/admin/books">
            Quản lý sách
          </Link>
          <Link className="btn btn-outline-primary" to="/admin/categories">
            Quản lý thể loại
          </Link>
          <Link className="btn btn-outline-primary" to="/admin/settings">
            Cài đặt hệ thống
          </Link>
        </div>
      </div>
